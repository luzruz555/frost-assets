  ...
  if (mode === 'h') {
    ...
    svg = `
      <svg width="1920" height="1080" viewBox="0 0 1920 1080" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- 제목 + 작성자 -->
        <text x="55" y="300" fill="${titleColor}" font-size="48" font-family="'Noto Sans KR', sans-serif" font-weight="700">${prefix}${title}</text>
        <text x="55" y="350" fill="${dimOrange}" font-size="34" font-family="'Noto Sans KR', sans-serif" font-weight="700">${author}</text>
